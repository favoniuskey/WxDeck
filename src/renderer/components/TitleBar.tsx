...
interface Props {
  ...
  onToggleDock: (kind: DockKind) => void;
  ventActive: boolean;
  pressionActive: boolean;
  dockWindActive: boolean;
  dockAtisActive: boolean;
  dockRawActive: boolean;
}
  ...
  return (
    <div className="draggable h-11 flex items-center justify-between px-3 border-b border-white/[0.06] bg-white/[0.02] backdrop-blur-xl">
      ...
      <div className="no-drag flex items-center gap-1">
        <DockMenu
          windActive={dockWindActive}
          atisActive={dockAtisActive}
          rawActive={dockRawActive}
